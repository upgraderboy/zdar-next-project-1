...
export const jobs = pgTable("jobs", {
    ...
    jobType: jobTypeEnum("job_type").notNull(), // e.g., Full-Time, Part-Time, Internship
    experienceLevel: experienceLevelEnum("experience_level").notNull(), // e.g., Junior, Mid, Senior
    softSkills: text("soft_skills").array(),
    hardSkills: text("hard_skills").array(),
...
export const jobApplications = pgTable("job_applications", {
    ...
    applicationStatus: applicationStatusEnum("application_status").default("PENDING"), // applied, shortlisted, hired, rejected
